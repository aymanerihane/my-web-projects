...
var dict = {
    ...
    "PHP": ["Côté serveur", "https://avatars.mds.yandex.net/i?id=4b542470beb720b5789a1e08ae067bc187e27abc-8514130-images-thumbs&n=13", "Hypertext Preprocessor: langage de programmation libre, principalement utilisé pour produire des pages Web dynamiques via un serveur web."],
  ...
  function ask(newElement) {
    ...
    if (iteam != null) {
      newElement.innerHTML ="<span class=\"text\">"+iteam + " </span><span class=\"insertBefore\" >⊷</span><span class=\"remove\" > ⋫ </span><span class=\"insertAfter\" > ⊶ </span>";
    }else{
  ...
  const totalWords = liElements.length;
  ...
  const averageWordsPerCategory = dis / totalCategories;
